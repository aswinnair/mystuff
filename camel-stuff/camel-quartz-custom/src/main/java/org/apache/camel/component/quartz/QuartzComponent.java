...
public class QuartzComponent extends DefaultComponent implements StartupListener {
    ...
    private QuartzEndpoint dynaEndpoint;
    ...
    protected QuartzEndpoint createEndpoint(final String uri, final String remaining, final Map<String, Object> parameters) throws Exception {
        ...
        Boolean dyna = getAndRemoveParameter(parameters, "dyna", Boolean.class, Boolean.FALSE);
        ...
        if (dyna) {
            return createDynaEndpoint(group, triggerParameters, jobParameters, uri, name);
        } else {        
    ...
    private QuartzEndpoint createDynaEndpoint(String group,
			Map<String, Object> triggerParameters,
			Map<String, Object> jobParameters, String endpointUri, String name) {

    	if (dynaEndpoint != null) {
    		return dynaEndpoint;
    	}
    	
    	DynaQuartzEndpoint quartzEndpoint = new DynaQuartzEndpoint(endpointUri, this, group, name);
    	dynaEndpoint = quartzEndpoint;
		return dynaEndpoint;
	}
